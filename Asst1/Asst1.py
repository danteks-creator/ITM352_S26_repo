...
def run_quiz():
    ...
    print("HOW TO ANSWER: Type the letter of your choice (e.g., 'a').", "For multiple answers, separate letters with spaces (e.g., 'a b c').", "Commas and capitalization will be ignored automatically.")
